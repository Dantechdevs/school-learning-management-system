...
<head>
    ...
    <!-- Styles -->
    <!-- Custom CSS -->
    <link href="{{asset('admin/dashboard/assets/libs/flot/css/float-chart.css')}}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{asset('admin/dashboard/dist/css/style.min.css')}}" rel="stylesheet">
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{asset('admin/dashboard/assets/images/logo-icon.png')}}" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{asset('admin/dashboard/assets/images/logo-text.png')}}" alt="homepage" class="light-logo" />
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{asset('admin/dashboard/assets/libs/jquery/dist/jquery.min.js')}}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{asset('admin/dashboard/assets/libs/popper.js/dist/umd/popper.min.js')}}"></script>
    <script src="{{asset('admin/dashboard/assets/libs/bootstrap/dist/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('admin/dashboard/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js')}}"></script>
    <script src="{{asset('admin/dashboard/assets/extra-libs/sparkline/sparkline.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('admin/dashboard/dist/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('admin/dashboard/dist/js/sidebarmenu.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('admin/dashboard/dist/js/custom.min.js')}}"></script>
    <!--This page JavaScript -->
    <!-- <script src="{{asset('admin/dashboard/dist/js/pages/dashboards/dashboard1.js')}}"></script> -->
    <!-- Charts js Files -->
    <script src="{{asset('admin/dashboard/assets/libs/flot/excanvas.js')}}"></script>
    <script src="{{asset('admin/dashboard/assets/libs/flot/jquery.flot.js')}}"></script>
    <script src="{{asset('admin/dashboard/assets/libs/flot/jquery.flot.pie.js')}}"></script>
    <script src="{{asset('admin/dashboard/assets/libs/flot/jquery.flot.time.js')}}"></script>
    <script src="{{asset('admin/dashboard/assets/libs/flot/jquery.flot.stack.js')}}"></script>
    <script src="{{asset('admin/dashboard/assets/libs/flot/jquery.flot.crosshair.js')}}"></script>
    <script src="{{asset('admin/dashboard/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js')}}"></script>
    <script src="{{asset('admin/dashboard/dist/js/pages/chart/chart-page-init.js')}}>"></script>
    @stack('modals')
